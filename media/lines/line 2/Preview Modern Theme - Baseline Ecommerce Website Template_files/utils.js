...
Line 16:26 Transforming default arguments to the configured target environment ("es5") is not supported yet
Line 17:2 Transforming const to the configured target environment ("es5") is not supported yet
Line 58:19 Transforming rest arguments to the configured target environment ("es5") is not supported yet
