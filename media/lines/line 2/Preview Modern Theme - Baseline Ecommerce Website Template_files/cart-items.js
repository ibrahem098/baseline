...
Line 33:24 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 67:12 Transforming let to the configured target environment ("es5") is not supported yet
Line 80:20 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 83:6 Transforming const to the configured target environment ("es5") is not supported yet
Line 101:4 Transforming async functions to the configured target environment ("es5") is not supported yet
Line 115:6 Transforming const to the configured target environment ("es5") is not supported yet
Line 126:8 Transforming const to the configured target environment ("es5") is not supported yet
Line 127:8 Transforming const to the configured target environment ("es5") is not supported yet
Line 151:14 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
