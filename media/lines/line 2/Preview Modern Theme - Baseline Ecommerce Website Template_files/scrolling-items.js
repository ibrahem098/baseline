...
Line 21:19 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 28:8 Transforming const to the configured target environment ("es5") is not supported yet
Line 59:22 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 64:0 Transforming class syntax to the configured target environment ("es5") is not supported yet
Line 65:13 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 69:19 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 76:27 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
