...
Line 41:7 Transforming let to the configured target environment ("es5") is not supported yet
...
Line 128:4 Transforming let to the configured target environment ("es5") is not supported yet
Line 128:8 Transforming destructuring to the configured target environment ("es5") is not supported yet
Line 170:2 Transforming let to the configured target environment ("es5") is not supported yet
Line 189:2 Transforming let to the configured target environment ("es5") is not supported yet
Line 190:2 Transforming let to the configured target environment ("es5") is not supported yet
...
function initInterceptors(data2) {
  ...
  let recurse = function (obj) {
    ...
    Object.entries(Object.getOwnPropertyDescriptors(obj)).forEach(_ref5 => {
      let [key, {
        value,
        enumerable
      }] = _ref5;
...
function injectMagics(obj, el) {
  Object.entries(magics).forEach(_ref6 => {
    let [name, callback] = _ref6;
...
function directives(el, attributes, originalAttributeOverride) {
  ...
  if (el._x_virtualDirectives) {
    let vAttributes = Object.entries(el._x_virtualDirectives).map(_ref7 => {
...
function start() {
  ...
  startObservingMutations();
  onElAdded(el => initTree$1(el, walk));
...
function applyBindingsObject(el, obj, original) {
  ...
  let attributes = Object.entries(obj).map(_ref19 => {
    let [name, value] = _ref19;
    return {
      name,
      value
    };
...
function injectDataProviders(obj, context) {
  Object.entries(datas).forEach(_ref20 => {
    let [name, callback] = _ref20;
    Object.defineProperty(obj, name, {
      get() {
        return function () {
...
function entangle(_ref22, _ref23) {
  let {
    get: outerGet,
    set: outerSet
  } = _ref22;
...
directive("modelable", (el, _ref24, _ref25) => {
  let {
    expression
  } = _ref24;
  let {
...
directive("teleport", (el, _ref26, _ref27) => {
  let {
    modifiers,
    expression
  } = _ref26;
...
var handler = () => {};
handler.inline = (el, _ref28, _ref29) => {
  let {
    modifiers
  } = _ref28;
  let {
...
directive("effect", (el, _ref30, _ref31) => {
  let {
    expression
  } = _ref30;
  let {
...
directive("model", (el, _ref32, _ref33) => {
  let {
    modifiers,
    expression
  } = _ref32;
  ...
  el._x_forceModelUpdate = value => {
    ...
    mutateDom$1(() => bind(el, "value", value));
...
directive("cloak", el => queueMicrotask(() => mutateDom$1(() => el.removeAttribute(prefix("cloak")))));

// packages/alpinejs/src/directives/x-init.js
addInitSelector(() => `[${prefix("init")}]`);
directive("init", skipDuringClone((el, _ref34, _ref35) => {
  let {
    expression
  } = _ref34;
  let {
...
directive("text", (el, _ref36, _ref37) => {
  let {
    expression
  } = _ref36;
  let {
...
directive("html", (el, _ref38, _ref39) => {
  let {
    expression
  } = _ref38;
  let {
...
var handler2 = (el, _ref40, _ref41) => {
  ...
  effect3(() => evaluate2(result => {
    ...
    mutateDom$1(() => bind(el, value, result, modifiers));
  }));
};
handler2.inline = (el, _ref42) => {
  let {
    value,
    modifiers,
    expression
  ...
  evaluateItems(items => {
    ...
    for (let i = 0; i < adds.length; i++) {
      ...
      clone2._x_refreshXForScope = newScope => {
        Object.entries(newScope).forEach(_ref50 => {
          let [key2, value] = _ref50;
...
function handler3() {}
handler3.inline = (el, _ref51, _ref52) => {
  let {
    expression
  } = _ref51;
  let {
...
directive("on", skipDuringClone((el, _ref57, _ref58) => {
  let {
    value,
    modifiers,
    expression
...
var src_default$5 = alpine_default;
...
function src_default$4(Alpine) {
  Alpine.directive("intersect", (el, _ref59, _ref60) => {
    let {
      value,
      expression,
      modifiers
...
function src_default$3(Alpine) {
  ...
  Alpine.directive("trap", Alpine.skipDuringClone((el, _ref61, _ref62) => {
    let {
      expression,
      modifiers
    } = _ref61;
...
function src_default(Alpine) {
  Alpine.directive("mask", (el, _ref67, _ref68) => {
    let {
      value,
      expression
    } = _ref67;
...
module_default$5.plugin(module_default$4);
module_default$5.plugin(module_default$3);
module_default$5.plugin(module_default$2);
module_default$5.plugin(module_default$1);
module_default$5.plugin(module_default);
window.Alpine = module_default$5;
window.Spruce = module_default$5;
module_default$5.magic('fetchedFragment', (el, _ref69) => {
  let {
    Alpine,
    evaluateLater
  } = _ref69;
  return function (url, selector) {
    let loadingClasses = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
    let classNames;
    if (loadingClasses) {
...
module_default$5.directive('html-if-set', (el, _ref70, _ref71) => {
  let {
    expression
  } = _ref70;
  let {
